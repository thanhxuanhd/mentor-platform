    ...
    <div className="flex items-center justify-between mb-8 bg-slate-700 rounded-lg p-6">
      {selectedMentor ? (
        <>
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400">{selectedMentor.expertise.join(", ")}</p>
        ...
        <div className="flex items-center justify-between w-full">
          <div>
            <h3 className="text-xl font-semibold text-gray-400">No mentor selected</h3>
            <p className="text-gray-400">Please select a mentor to book a session.</p>
          </div>
          <div className="flex space-x-2">
            <Button
              type="primary"
