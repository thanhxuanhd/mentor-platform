import { PlusOutlined, ShareAltOutlined } from "@ant-design/icons/lib/icons";
import {
  type GetProp,
  type UploadProps,
  Button,
      ...
      <div className="text-white p-6 rounded-xl max-w-3xl my-10 mx-auto">
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            ...
            <Tag color="orange" className="mt-1">{userData?.role || "User"}</Tag>
          </div>
        </div>
        ...
        <div className="hidden">
          <Form form={form} layout="vertical" name="user_profile_form" requiredMark={false}>
              ...
              <div className="flex gap-2 items-center justify-center">
                {availabilityOptions.map((item) => (
                  <Button
                    ...
                    className={selectedAvailability.includes(item) ? "bg-orange-500 border-none" : ""}
                    size="large"
